...
#ifndef POFYZ_2020_LS_ZADANIE_A3_ARGUMENTS_TABLES_ARGUMENTSTABLE_H
#define POFYZ_2020_LS_ZADANIE_A3_ARGUMENTS_TABLES_ARGUMENTSTABLE_H

#include <stddef.h>

#define ARGUMENTS_TABLE_PARAMETERS    0
#define ARGUMENTS_TABLE_INTOPTIONS    1
#define ARGUMENTS_TABLE_STRINGOPTIONS 2
...
#endif //POFYZ_2020_LS_ZADANIE_A3_ARGUMENTS_TABLES_ARGUMENTSTABLE_H
